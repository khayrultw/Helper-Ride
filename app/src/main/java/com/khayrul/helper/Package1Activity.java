...
public class Package1Activity extends AppCompatActivity {
    ...
    public void orderPackage1(View view){
        ...
        Intent intent = new Intent(Package1Activity.this, HelperCookOrderActivity.class);
